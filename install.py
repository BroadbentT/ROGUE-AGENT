...
list1 = ["snmp", "proxychains4", "bloodhound", "sqlite3", "hashcat", "python3-ldap", "gobuster", "crackmapexec", "exiftool", "rlwrap", "xdotool", "sshpass", "seclists"]
...
os.system("mv RopCrasher.py /BLACKBRIAR/RopCrasher.py")
