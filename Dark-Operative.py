...
def options():
   ...
   print('\u2551' + "(05) Re/Set WEBSITE URL (15) Re/Set KERB AUTH (35) DComExec (45) Enum EndPoints (55) ASREPRoasting (65) Disp Ticket (75) ExplCreator (85) GenListPass (95 ) Netcat   (235) Light Serv Scan (345) Edit Resolv.conf (445) EnumVirtHOST (604) Domain    Dumo (704) Certipy ESC4 (714) Certify   ESC14  " + '\u2551')
...
# -------------------------------------------------------------------------------------
   ...
   if selection =='96':
      ...
      if checkParam != 1:
         ...
         print("[i] If you receive an error message stating 'The login is from an untrusted domain and cannot be used with Integrated authentication.' reset the kerberos authentication type...\n") 
         localCOM("echo '" + Green + "'")                             
      if checkParam != 1:
         if PAS[:1] != " ":
...
# Version : TREADSTONE     
# Details : Menu option selected -                                                     
# Old     : Menu option selected - Bloody-AD add group
# Modified: N/A
# -------------------------------------------------------------------------------------
